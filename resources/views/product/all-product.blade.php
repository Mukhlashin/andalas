...
@section('sub_category')
  <h6 class="text-tengah" style="font-weight: 500;color: #315343; padding: 10px; text-align: center; font-size: 2.5rem !important; margin-top: 25px" >{{$data_category->sub_category->name}}</h6>
  <p class="text-tengah" style="font-size: 1.1vw; font-weight: 300; text-align: center; padding: 10px; margin-top: 10px; margin-bottom: 30px" >{{$data_category->sub_category->description}}</p>
  <hr>
@endsection
