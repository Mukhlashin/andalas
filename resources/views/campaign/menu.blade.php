...
<div class="container-fluid" style="margin-top: 140px; margin-bottom: 30px">
              ...
              <div class="row no-gutters" style="margin-bottom: 30px">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="card" style="width: 21rem;border: none">
                    ...
                    <div class="card-body">
                      <p class="card-caption" style="font-size: 13px;">By {{$dataCampaign->author}} |  {{date('d-m-Y', strtotime($dataCampaign->created_at))}}</p>
                    <p class="card-text" style="overflow: hidden; font-size: 19px; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 4; line-clamp: 4; -webkit-box-orient: vertical;" >{{$dataCampaign->description}}</p>
